...
#define MDNS_NAME "SpectaculEARS" // mDNS hostname, ie: *.local

#define WLED_MAX_BUTTONS 2 // Maximum number of buttons
#define LEDPIN 1
#define DEFAULT_LED_COUNT 88 //SpectaculEARS has 88 LEDs
#define WLED_AP_SSID "SpectaculEARS" // Name of default WLED access point
#define WLED_AP_PASS "itmightbemagic" // Password for default WLED access point

#define WLED_VERSION "SE"
#define BTNPIN 9 
